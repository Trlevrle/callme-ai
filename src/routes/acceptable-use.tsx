      ...
      <section className="mx-auto max-w-2xl px-4 py-20 sm:px-6 md:py-28">
        ...
        <div className="mt-8 space-y-5 text-sm text-foreground/80">
          ...
          <ul className="list-inside list-disc space-y-1">
            ...
            <li>Generate content involving minors in any sexual, romantic, or otherwise intimate context</li>
            <li>Generate content depicting real, named, or identifiable public figures in intimate contexts</li>
          ...
          <p>
            Violations result in immediate suspension. We report illegal
