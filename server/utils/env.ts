...
function applyEnvValues(values: Record<string, string>) {
  for (const [key, value] of Object.entries(values)) {
    ...
    const aliases: Record<string, string> = {
      ...
      OHAPI_API_KEY: "VITE_OHAPI_API_KEY",
      OHAPI_API_KEY_FALLBACK: "VITE_OHAPI_API_KEY_FALLBACK",
      OHAPI_BASE_URL: "VITE_OHAPI_BASE_URL",
      OHAPI_CHAT_PATH: "VITE_OHAPI_CHAT_PATH",
      OHAPI_NSFW_MODEL: "VITE_OHAPI_NSFW_MODEL",
      OHAPI_NSFW_MODEL_FALLBACK: "VITE_OHAPI_NSFW_MODEL_FALLBACK",
      UNCENSORED_API_KEY: "VITE_UNCENSORED_API_KEY",
      UNCENSORED_API_KEY_FALLBACK: "VITE_UNCENSORED_API_KEY_FALLBACK",
      UNCENSORED_BASE_URL: "VITE_UNCENSORED_BASE_URL",
      UNCENSORED_IMAGE_PATH: "VITE_UNCENSORED_IMAGE_PATH",
      UNCENSORED_NSFW_MODEL: "VITE_UNCENSORED_NSFW_MODEL",
      UNCENSORED_NSFW_MODEL_FALLBACK: "VITE_UNCENSORED_NSFW_MODEL_FALLBACK",
