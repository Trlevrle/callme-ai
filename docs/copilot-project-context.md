...
- All terminal execution requires explicit user confirmation.
- User intentionally keeps agents in no-auto-execute mode after prior incident.
- If any setting appears to allow auto-approval, this policy prevails.
